...
public class EmailService {
    ...
    /**************************************************************************************************************/
    // public Response sendResetpasswordEmail(String email, HttpServletRequest
    // request, String verficationToken) {
    ...
    // sendEmail(email, content, subject, senderName);

    // return new Response(HttpStatus.OK, "Please, check your email to reset your
    // password", null);
    // } catch (Exception e) {
    ...
    // public Response sendRegistrationVerificationCode(String email,
    ...
    // return new Response(HttpStatus.OK, "Email is not verfied ,please check your
    // email to verfy it!", null);
    // } catch (Exception e) {

    // return new Response(HttpStatus.BAD_REQUEST, "Error while sending email",
    // null);
