...
public class RefundController {
      ...
      @PostMapping("/refund")
      public ResponseEntity<String> createRefund(@RequestBody RefundRequest refundRequest) throws JsonMappingException, JsonProcessingException {
            ...
            return refundService.check(refundRequest)? new ResponseEntity<>("Refund successful", HttpStatus.OK): new ResponseEntity<>("Refund failed", HttpStatus.BAD_REQUEST);
      }
}